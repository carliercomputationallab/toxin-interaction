...
<!-- generated with COPASI 4.39 (Build 272) (http://www.copasi.org) at 2023-04-12T16:35:53Z -->
...
<rdf:Description rdf:about="#Function_49">
  ...
  <Model key="Model_0" name="0D_HAandIS_Albumin_Model_Healthy_Application0" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="0.01*m²" lengthUnit="0.1*m" quantityUnit="µmol" type="deterministic" avogadroConstant="6.0221417899999999e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<rdf:Description rdf:about="#Reaction_0">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8762" name="Kf_Complex_IS_Complex" value="0.0024592"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_1">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8723" name="Kf_Complex_HA_Complex" value="0.000147675"/>
          <Constant key="Parameter_8724" name="f_HA_Complex" value="0.06"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_2">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8725" name="Kf_IS_Up" value="2.83424e-06"/>
          <Constant key="Parameter_8729" name="Kr_IS_Up" value="0"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_3">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8722" name="Kf_IS_Diss" value="8.69565e-05"/>
          <Constant key="Parameter_8721" name="Kr_IS_Diss" value="0"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_4">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8720" name="Kf_HA_up" value="1.41062e-07"/>
          <Constant key="Parameter_8766" name="Kr_HA_up" value="0"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_5">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8764" name="Kf_HA_Diss" value="0.000612008"/>
          <Constant key="Parameter_8765" name="Kr_HA_Diss" value="0"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_6">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8767" name="Km_IS_Efflux" value="69"/>
          <Constant key="Parameter_8770" name="Vmax_IS_Efflux" value="0.000388865"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_7">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8726" name="Km_HA_Efflux" value="69"/>
          <Constant key="Parameter_5311" name="Vmax_HA_Efflux" value="0.000388865"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Compartments[Blood],Vector=Metabolites[IS_B]" value="1505535447500000" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Compartments[Blood],Vector=Metabolites[HA_B]" value="36795286336900000" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Compartments[basolateral],Vector=Metabolites[IS_OAT1]" value="10131751259164.238" type="Species" simulationType="reactions"/>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Values[Kf_IS_Up]" value="2.8342388900000002e-06" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Values[Km_IS_Diss]" value="10674.047699999999" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Values[Bmax_IS_Diss]" value="0.98130836369999996" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Values[Kf_IS_Diss]" value="8.6956510046475052e-05" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Values[Kf_HA_up]" value="1.4106248489999999e-07" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Values[Km_HA_Diss]" value="0.80897731809999995" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Values[Bmax_HA_Diss]" value="0.37443200160000001" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Values[Kf_HA_Diss]" value="0.000612008021263997" type="ModelValue" simulationType="assignment"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Reactions[IS_Up]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Reactions[IS_Up],ParameterGroup=Parameters,Parameter=Kf_IS_Up" value="2.8342388900000002e-06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Reactions[IS_Diss]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Reactions[IS_Diss],ParameterGroup=Parameters,Parameter=Kf_IS_Diss" value="8.6956510046475052e-05" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Reactions[HA_up]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Reactions[HA_up],ParameterGroup=Parameters,Parameter=Kf_HA_up" value="1.4106248489999999e-07" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Reactions[HA_Diss]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=0D_HAandIS_Albumin_Model_Healthy_Application0,Vector=Reactions[HA_Diss],ParameterGroup=Parameters,Parameter=Kf_HA_Diss" value="0.000612008021263997" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
      ...
      <ModelParameterSet key="ModelParameterSet_3" name="Parameter Set 2023-03-03T17:08:02">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#ModelParameterSet_3">
    ...
    <InitialState type="initialState">
      0 60221417899999992 368000000000000.06 0 0 0 0 0 0 0 36795286336900000 10131751259164.238 1505535447500000 0.002459195569804722 0.00014767547857793984 8.6956510046475052e-05 0.000612008021263997 0.00038886497224104727 0.00038886497224104727 3.2000000000000001e-07 0.0001 0.0001 0.0032000000000000002 0.0032000000000000002 0 0 96485.3321 0.0016605387831627261 97.920000000000002 2.7000000000000002 0.059999999999999998 97 2.7000000000000002 2.8342388900000002e-06 0 0 10674.047699999999 0.98130836369999996 1.4106248489999999e-07 0 0 0.80897731809999995 0.37443200160000001 69 69 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_12" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <Parameter name="StepNumber" type="unsignedInteger" value="2149"/>
        <Parameter name="StepSize" type="float" value="2607.0763499999998"/>
        <Parameter name="Duration" type="float" value="5600000"/>
